...
export const en: Messages = {
  ...
  activity: {
    title: "My activity",
    subtitle: "Tickets assigned to you, across all projects.",
    todo: "To do",
    doing: "In progress",
    done: "Done",
    empty: "No ticket is assigned to you at the moment.",
    emptyTodo: "Nothing waiting.",
    emptyDoing: "Nothing in progress.",
    emptyDone: "Nothing completed.",
    more: "+ {count} more",
